...
class TestSearchSVOD:
    ...
    def test_search_svod(self, setup):
        ...
        search_page = home_page.click_navigation_search()
        search_page.set_search_input(self.kononii_ner)   # kinoniihoo neriig bicheed haih
        time.sleep(2) # search result loading
        ...
        latesttest_response(self.driver)
